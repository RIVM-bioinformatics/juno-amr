...
class JunoAmr(Pipeline):
    ...
    def _add_args_to_parser(self) -> None:
        ...
        self.parser.description = (
            "Juno-amr pipeline. Automated pipeline for bacterial AMR analysis."
        )
    ...
    def setup(self) -> None:
        ...
        self.user_parameters = {
            ...
            "pointfinder_db": str(
                self.db_dir.joinpath("pointfinder_2_4_0/pointfinder_db")
            ),
    ...
    def update_sample_dict_with_metadata(self) -> None:
        ...
        self.get_metadata_from_csv_file(
            ...
            expected_colnames=["sample", "full_species_name"],
        )
